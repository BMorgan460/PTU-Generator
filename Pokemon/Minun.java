public class Minun extends Pokemon{
{
		...
		type1 = "Electric";
		type2 = "";
		abilities = new String[]{"Minus", "Static", "Cute Charm", "Sequence", "Absorb"};
		...
		moves = new String[]{"Growl", "Nuzzle", "Thunder Wave", "Quick Attack", "Helping Hand", "Spark", "Encore", "Switcheroo", "Swift", "Electro Ball", "Copycat", "Fake Tears", "Charge", "Discharge", "Baton Pass", "Agility", "Trump Card", "Thunder", "Nasty Plot", "Entrainment"};
