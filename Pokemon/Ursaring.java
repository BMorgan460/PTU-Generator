public class Ursaring extends Pokemon{
	{
		...
		type1 = "Normal";
		type2 = "";
		abilities = new String[]{"Guts", "Quick Feet", "Unnerve", "Frighten", "Bodyguard"};
		abilityTypeCount = new int[] {2,2,1};
		previous = new Teddiursa();
		prevReq = 30;
		height = "5\'/11\"";
		weight = 277.3;
		WC = 5;
