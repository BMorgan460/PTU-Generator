public class Zygarde extends Pokemon{
	{
		...
		type1 = "Dragon";
		type2 = "Ground";
		abilities = new String[]{"Aura Break", "Interference", "Air Lock", "Filter", "Pressure"};
		...
		power = 9;
		underdog = false;
		other = new String[]{"Darkvision","Forme Change","Forme Change","Groundshaper","Mountable 4","Tremorsense"};
		athl = 4;
		acro = 3;
		combat = 4;
		stealth = 4;
