public class Charmander extends Pokemon{
	{
		...
		eggMoves = new String[]{"Air Cutter", "Ancient Power", "Beat Up", "Belly Drum", "Bite", "Counter", "Crunch", "Dragon Dance", "Dragon Rush", "Flare Blitz", "Focus Punch", "Metal Claw", "Outrage", "Rock Slide", "Swords Dance"};
		tutorMoves = new String[]{"Body Slam", "Slam", "Counter", "Defense Curl", "Dynamic Punch", "Fire Pledge", "Fire Punch", "Fury Cutter", "Heat Wave", "Iron Tail", "Mega Kick", "Mega Punch", "Outrage", "Rage", "Seismic Toss", "Sleep Talk", "Snore", "Swift", "Thunder Punch"};
