public class Fletchling extends Pokemon{
	{
		...
		TMs = new String[]{"Fly", "Toxic", "Hidden Power", "Sunny Day", "Taunt", "Protect", "Roost", "Frustration", "Return", "Double Team", "Aerial Ace", "Facade", "Flame Charge", "Rest", "Attract", "Thief", "Round", "Overheat", "Steel Wing", "Acrobatics", "Swords Dance", "Swagger", "Sleep Talk", "Substitute", "Confide"};
