public class Pinsir extends Pokemon{
	{
		...
		type1 = "Bug";
		type2 = "";
		abilities = new String[]{"Hyper Cutter", "Mold Breaker", "Moxie", "Kampfgeist", "Parry"};
		...
		TMs = new String[]{"Cut", "Strength", "Toxic", "Bulk Up", "Hidden Power", "Sunny Day", "Hyper Beam", "Protect", "Rain Dance", "Frustration", "Smack Down", "Earthquake", "Return", "Dig", "Brick Break", "Double Team", "Rock Tomb", "Facade", "Rest", "Attract", "Thief", "Round", "Focus Blast", "False Swipe", "Fling", "Giga Impact", "Stone Edge", "Swords Dance", "Struggle Bug", "Bulldoze", "Rock Slide", "Swagger", "Sleep Talk", "Substitute", "Rock Smash"};
