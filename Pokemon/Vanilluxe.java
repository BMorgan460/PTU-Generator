public class Vanilluxe extends Pokemon{
{
		...
		TMs = new String[]{"Toxic", "Hail", "Hidden Power", "Taunt", "Ice Beam", "Blizzard", "Hyper Beam", "Light Screen", "Protect", "Rain Dance", "Frustration", "Return", "Double Team", "Facade", "Rest", "Attract", "Round", "Explosion", "Giga Impact", "Frost Breath", "Swagger", "Sleep Talk", "Substitute", "Flash Cannon"};
