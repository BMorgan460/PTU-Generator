public class Abra extends Pokemon{
	{
		...
		eggMoves = new String[]{"Ally Switch", "Barrier", "Encore", "Fire Punch", "Guard Split", "Guard Swap", "Ice Punch", "Knock Off", "Power Trick", "Trick", "Psychic Terrain", "Psycho Shift", "Skill Swap", "Thunder Punch"};
