public class Graveler extends Pokemon{
{
		...
		type1 = "Rock";
		type2 = "";
		abilities = new String[]{"Run Up", "Sand Veil", "Sturdy", "Bulletproof", "Head"};
