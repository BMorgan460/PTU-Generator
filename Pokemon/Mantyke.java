public class Mantyke extends Pokemon{
	{
		...
		TMs = new String[]{"Surf", "Waterfall", "Dive", "Toxic", "Hail", "Hidden Power", "Ice Beam", "Blizzard", "Protect", "Rain Dance", "Frustration", "Earthquake", "Return", "Double Team", "Aerial Ace", "Facade", "Rest", "Attract", "Round", "Scald", "Acrobatics", "Bulldoze", "Rock Slide", "Swagger", "Sleep Talk", "Substitute"};
