public class Bulbasaur extends Pokemon{
	{
		...
		eggMoves = new String[]{"Amnesia", "Charm", "Curse", "Endure", "Giga Drain", "Grass Whistle", "Grassy Terrain", "Ingrain", "Leaf Storm", "Light Screen", "Magical Leaf", "Nature Power", "Petal Dance", "Power Whip", "Safeguard", "Skull Bash", "Sludge"};
