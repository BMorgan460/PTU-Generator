public class Pidgey extends Pokemon{
{
		...
		type1 = "Normal";
		type2 = "";
		abilities = new String[]{"Keen Eye", "Tangled Feet", "Big Pecks", "Blow Away", "Away"};
		...
		eggMoves = new String[]{"Air Cutter", "Air Slash", "Slash", "Brave Bird", "Defog", "Feint Attack", "Foresight", "Pursuit", "Steel Wing", "Uproar"};
		tutorMoves = new String[]{"Air Cutter", "Defog", "Heat Wave", "Ominous Wind", "Pluck", "Roost", "Sky Attack", "Sleep Talk", "Snore", "Swift", "Tailwind", "Twister", "Uproar", "Work Up"};
