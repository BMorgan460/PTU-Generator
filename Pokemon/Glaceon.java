public class Glaceon extends Pokemon{
{
		...
		TMs = new String[]{"Roar", "Toxic", "Hail", "Hidden Power", "Sunny Day", "Ice Beam", "Blizzard", "Hyper Beam", "Protect", "Rain Dance", "Frustration", "Return", "Dig", "Shadow Ball", "Double Team", "Facade", "Rest", "Attract", "Round", "Echoed Voice", "Retaliate", "Giga Impact", "Frost Breath", "Swagger", "Sleep Talk", "Substitute", "Rock Smash"};
