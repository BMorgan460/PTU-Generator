public class Buneary extends Pokemon{
{
		...
		type1 = "Normal";
		type2 = "";
		abilities = new String[]{"Cute Charm", "Klutz", "Limber", "Vigor", "Feet"};
		...
		TMs = new String[]{"Toxic", "Hidden Power", "Sunny Day", "Ice Beam", "Protect", "Rain Dance", "Frustration", "Solar Beam", "Thunderbolt", "Return", "Dig", "Shadow Ball", "Double Team", "Facade", "Rest", "Attract", "Round", "Fling", "Charge Beam", "Retaliate", "Thunder Wave", "Grass Knot", "Swagger", "Sleep Talk", "Substitute", "Rock Smash", "PowerUp", "Confide"};
