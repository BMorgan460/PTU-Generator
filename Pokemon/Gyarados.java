public class Gyarados extends Pokemon{
{
		...
		TMs = new String[]{"Roar", "Toxic", "Hail", "Hidden Power", "Taunt", "Ice Beam", "Blizzard", "Hyper Beam", "Protect", "Rain Dance", "Frustration", "Thunderbolt", "Thunder", "Earthquake", "Return", "Double Team", "Flamethrower", "Sandstorm", "Fire Blast", "Torment", "Facade", "Rest", "Attract", "Round", "Scald", "Incinerate", "Payback", "Giga Impact", "Stone Edge", "Thunder Wave", "Bulldoze", "Dragon Tail", "Swagger", "Sleep Talk", "Substitute", "Rock Smash", "Dark Pulse"};
