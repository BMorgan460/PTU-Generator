public class Vigoroth extends Pokemon{
	{
		...
		TMs = new String[]{"Cut", "Strength", "Hone Claws", "Roar", "Toxic", "Bulk Up", "Hidden Power", "Sunny Day", "Taunt", "Ice Beam", "Blizzard", "Protect", "Rain Dance", "Frustration", "Solar Beam", "Thunderbolt", "Thunder", "Earthquake", "Return", "Shadow Ball", "Brick Break", "Double Team", "Flamethrower", "Fire Blast", "Rock Tomb", "Aerial Ace", "Facade", "Rest", "Attract", "Low Sweep", "Round", "Focus Blast", "Fling", "Incinerate", "Shadow Claw", "Retaliate", "Bulldoze", "Rock Slide", "Swagger", "Sleep Talk", "Substitute", "Rock Smash", "Confide"};
		tutorMoves = new String[]{"After You", "Body Slam", "Slam", "Covet", "Dynamic Punch", "Fire Punch", "Fury Cutter", "Gunk Shot", "Ice Punch", "Icy Wind", "Low Kick", "Mega Kick", "Mega Punch", "Rock Climb", "Seismic Toss", "Shock Wave", "Sleep Talk", "Snore", "Sucker Punch", "Thunder Punch", "Water Pulse", "Uproar", "Work Up"};
