public class Pineco extends Pokemon{
	{
		...
		TMs = new String[]{"Strength", "Toxic", "Venoshock", "Hidden Power", "Sunny Day", "Light Screen", "Protect", "Frustration", "Solar Beam", "Earthquake", "Return", "Dig", "Double Team", "Reflect", "Sandstorm", "Rock Tomb", "Facade", "Rest", "Attract", "Round", "Explosion", "Payback", "Gyro Ball", "Struggle Bug", "Bulldoze", "Rock Slide", "Swagger", "Sleep Talk", "Substitute", "Rock Smash"};
