public class Teddiursa extends Pokemon{
	{
		...
		type1 = "Normal";
		type2 = "";
		abilities = new String[]{"Pickup", "Quick Feet", "Deep Sleep", "Honey Paws", "Lunchbox"};
		abilityTypeCount = new int[] {2,2,1};
		next = new String[]{"Ursaring"};
		...
		underdog = true;
		other = new String[]{"Tracker","Stealth","Honey Gather"};
		athl = 1;
		acro = 2;
		combat = 2;
		stealth = 4;
