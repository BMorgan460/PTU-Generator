public class Rhydon extends Pokemon{
	{
		...
		type1 = "Ground";
		type2 = "Rock";
		abilities = new String[]{"Lightning Rod", "Solid Rock", "Reckless", "Rock Head", "Run Up"};
