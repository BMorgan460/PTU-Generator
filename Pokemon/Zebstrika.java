public class Zebstrika extends Pokemon{
{
		...
		type1 = "Electric";
		type2 = "";
		abilities = new String[]{"Lightning Rod", "Motor Drive", "Sprint", "Thunder Boost", "Sipper"};
		...
		TMs = new String[]{"Toxic", "Hidden Power", "Hyper Beam", "Light Screen", "Protect", "Rain Dance", "Frustration", "Thunderbolt", "Thunder", "Return", "Double Team", "Facade", "Flame Charge", "Rest", "Attract", "Round", "Overheat", "Charge Beam", "Giga Impact", "Flash", "Volt Switch", "Thunder Wave", "Swagger", "Sleep Talk", "Substitute", "Wild Charge", "Rock Smash"};
