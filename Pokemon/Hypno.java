public class Hypno extends Pokemon{
	{
		...
		type1 = "Psychic";
		type2 = "";
		abilities = new String[]{"Insomnia", "Forewarn", "Inner Focus", "Hypnotic", "Dreamspinner"};
