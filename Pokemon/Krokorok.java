public class Krokorok extends Pokemon{
	{
		...
		TMs = new String[]{"Cut", "Strength", "Hone Claws", "Roar", "Toxic", "Hidden Power", "Taunt", "Protect", "Frustration", "Earthquake", "Return", "Dig", "Brick Break", "Double Team", "Sludge", "Sludge Bomb", "Sandstorm", "Rock Tomb", "Torment", "Facade", "Rest", "Attract", "Thief", "Low Sweep", "Round", "Fling", "Incinerate", "Embargo", "Shadow Claw", "Payback", "Retaliate", "Stone Edge", "Bulldoze", "Rock Slide", "Grass Knot", "Swagger", "Sleep Talk", "Substitute", "Rock Smash", "Snarl", "Dark Pulse", "Confide"};
		tutorMoves = new String[]{"Aqua Tail", "Dark Pulse", "Earth Power", "Foul Play", "Iron Tail", "Knock Off", "Low Kick", "Sleep Talk", "Snatch", "Snore", "Spite", "Stealth Rock", "Uproar"};
