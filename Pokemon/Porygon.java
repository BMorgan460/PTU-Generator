public class Porygon extends Pokemon{
	{
		...
		percepBonus = 0;
		focusBonus = 0;
		movesLevels = new int[]{1, 1, 1, 1, 7, 12, 18, 23, 29, 34, 40, 45, 50, 56, 62};
		...
		tutorMoves = new String[]{"Ally Switch", "Electroweb", "Foul Play", "Gravity", "Icy Wind", "Iron Tail", "Last Resort", "Magic Coat", "Magnet Rise", "Mimic", "Pain Split", "Recycle", "Role Play", "Shock Wave", "Signal Beam", "Snore", "Swift", "Telekinesis", "Trick", "Wonder Room", "Zen Headbutt", "Headbutt"};
