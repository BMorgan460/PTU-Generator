public class Hawlucha extends Pokemon{
{
		...
		type1 = "Fighting";
		type2 = "";
		abilities = new String[]{"Limber", "Unburden", "Hustle", "Keen Eye", "Breaker"};
		...
		TMs = new String[]{"Hone Claws", "Toxic", "Bulk Up", "Hidden Power", "Sunny Day", "Taunt", "Protect", "Rain Dance", "Roost", "Frustration", "Return", "Dig", "Brick Break", "Double Team", "Rock Tomb", "Aerial Ace", "Torment", "Facade", "Rest", "Attract", "Low Sweep", "Round", "Steel Wing", "Focus Blast", "False Swipe", "Fling", "Sky Drop", "Acrobatics", "Payback", "Retaliate", "Giga Impact", "Stone Edge", "Swords Dance", "Rock Slide", "XScissor", "Poison Jab", "Grass Knot", "Swagger", "Sleep Talk", "UTurn", "Substitute", "Rock Smash", "PowerUp", "Confide"};
