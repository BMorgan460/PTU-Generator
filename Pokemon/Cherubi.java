public class Cherubi extends Pokemon{
	{
		...
		eggMoves = new String[]{"Aromatherapy", "Defense Curl", "Flower Shield", "Grass Whistle", "Grassy Terrain", "Heal Pulse", "Healing Wish", "Wish", "Natural Gift", "Razor Leaf", "Rollout", "Seed Bomb", "Sweet Scent", "Tickle", "Weather Ball"};
