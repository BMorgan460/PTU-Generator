public class Phantump extends Pokemon{
{
		...
		type1 = "Ghost";
		type2 = "";
		abilities = new String[]{"Natural Cure", "Frisk", "Harvest", "Life Force", "Guard"};
		...
		TMs = new String[]{"Toxic", "Hidden Power", "Sunny Day", "Protect", "Safeguard", "Frustration", "Solar Beam", "Return", "Dig", "Psychic", "Shadow Ball", "Double Team", "Reflect", "Facade", "Rest", "Attract", "Thief", "Round", "Energy Ball", "WillOWisp", "Shadow Claw", "Bulldoze", "Rock Slide", "Poison Jab", "Dream Eater", "Grass Knot", "Swagger", "Sleep Talk", "Substitute", "Trick Room", "Rock Smash", "Nature Power", "Dark Pulse", "Confide"};
