public class Gligar extends Pokemon{
	{
		...
		TMs = new String[]{"Cut", "Strength", "Hone Claws", "Toxic", "Venoshock", "Hidden Power", "Sunny Day", "Taunt", "Protect", "Rain Dance", "Roost", "Frustration", "Earthquake", "Return", "Dig", "Brick Break", "Double Team", "Sludge", "Sludge Bomb", "Sandstorm", "Rock Tomb", "Aerial Ace", "Torment", "Facade", "Rest", "Attract", "Thief", "Round", "Steel Wing", "False Swipe", "Fling", "Acrobatics", "Payback", "Rock Polish", "Stone Edge", "Swords Dance", "Struggle Bug", "Bulldoze", "Rock Slide", "Poison Jab", "Swagger", "Sleep Talk", "Substitute", "Rock Smash", "Dark Pulse"};
