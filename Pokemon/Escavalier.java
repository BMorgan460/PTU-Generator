public class Escavalier extends Pokemon{
{
		...
		TMs = new String[]{"Toxic", "Hidden Power", "Hyper Beam", "Protect", "Rain Dance", "Frustration", "Return", "Double Team", "Aerial Ace", "Facade", "Rest", "Attract", "Round", "Focus Blast", "Energy Ball", "False Swipe", "Giga Impact", "Swords Dance", "Struggle Bug", "XScissor", "Infestation", "Poison Jab", "Swagger", "Sleep Talk", "Substitute", "Rock Smash"};
