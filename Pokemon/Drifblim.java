public class Drifblim extends Pokemon{
	{
		...
		TMs = new String[]{"Cut", "Fly", "Calm Mind", "Toxic", "Hidden Power", "Sunny Day", "Hyper Beam", "Protect", "Rain Dance", "Frustration", "Thunderbolt", "Thunder", "Return", "Psychic", "Shadow Ball", "Double Team", "Facade", "Rest", "Attract", "Thief", "Round", "Charge", "Charge Beam", "Acrobatics", "Embargo", "Explosion", "Payback", "Giga Impact", "Flash", "Thunder", "Thunder Wave", "Gyro Ball", "Psych Up", "Dream Eater", "Swagger", "Sleep Talk", "Substitute"};
		tutorMoves = new String[]{"Air Cutter", "Bind", "Defog", "Icy Wind", "Knock Off", "Magic Coat", "Ominous Wind", "Pain Split", "Phantom Force", "Recycle", "Role Play", "Rollout", "Shock Wave", "Silver Wind", "Skill Swap", "Sleep Talk", "Snore", "Spite", "Sucker Punch", "Swift", "Tailwind", "Telekinesis", "Trick"};
