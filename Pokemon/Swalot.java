public class Swalot extends Pokemon{
{
		...
		TMs = new String[]{"Toxic", "Venoshock", "Hidden Power", "Sunny Day", "Ice Beam", "Hyper Beam", "Protect", "Rain Dance", "Frustration", "Solar Beam", "Earthquake", "Return", "Shadow Ball", "Double Team", "Sludge Wave", "Sludge Bomb", "Facade", "Rest", "Attract", "Round", "Explosion", "Giga Impact", "Bulldoze", "Infestation", "Dream Eater", "Swagger", "Sleep Talk", "Substitute", "Rock Smash", "PowerUp", "Confide"};
