public class Pelipper extends Pokemon{
{
		...
		type1 = "Water";
		type2 = "";
		abilities = new String[]{"Keen Eye", "Gluttony", "Rain Dish", "Lunchbox", "Swallow"};
		...
		TMs = new String[]{"Toxic", "Hail", "Hidden Power", "Ice Beam", "Blizzard", "Hyper Beam", "Protect", "Rain Dance", "Roost", "Frustration", "Return", "Double Team", "Aerial Ace", "Facade", "Rest", "Attract", "Thief", "Round", "Echoed Voice", "Steel Wing", "Scald", "Fling", "Sky Drop", "Payback", "Giga Impact", "Swagger", "Sleep Talk", "UTurn", "Substitute"};
