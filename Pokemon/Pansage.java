public class Pansage extends Pokemon{
	{
		...
		eggMoves = new String[]{"Astonish", "Bullet Seed", "Covet", "Disarming Voice", "Grass Whistle", "Leaf Storm", "Low Kick", "Magical Leaf", "Nasty Plot", "Role Play", "Spiky Shield", "Tickle"};
