public class Breloom extends Pokemon{
	{
		...
		TMs = new String[]{"Cut", "Strength", "Toxic", "Bulk Up", "Venoshock", "Hidden Power", "Sunny Day", "Hyper Beam", "Protect", "Safeguard", "Frustration", "Solar Beam", "Return", "Brick Break", "Double Team", "Sludge", "Sludge Bomb", "Rock Tomb", "Facade", "Rest", "Attract", "Low Sweep", "Round", "Focus Blast", "Energy Ball", "False Swipe", "Fling", "Retaliate", "Giga Impact", "Flash", "Stone Edge", "Swords Dance", "Rock Slide", "Grass Knot", "Swagger", "Sleep Talk", "Substitute", "Rock Smash", "Confide"};
