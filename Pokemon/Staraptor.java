public class Staraptor extends Pokemon{
	{
		...
		percepBonus = 2;
		focusBonus = 0;
		movesLevels = new int[]{5, 9, 13, 18, 23, 28, 33, 41, 49, 57};
		...
		tutorMoves = new String[]{"Air Cutter", "Defog", "Endeavor", "Heat Wave", "Laser Focus", "Ominous Wind", "Pluck", "Sky Attack", "Snore", "Swift", "Tailwind", "Twister", "Uproar"};
