public class Combusken extends Pokemon{
{
		...
		TMs = new String[]{"Hone Claws", "Toxic", "Bulk Up", "Hidden Power", "Sunny Day", "Protect", "Frustration", "Return", "Dig", "Brick Break", "Double Team", "Flamethrower", "Fire Blast", "Rock Tomb", "Aerial Ace", "Facade", "Flame Charge", "Rest", "Attract", "Low Sweep", "Round", "Echoed Voice", "Overheat", "Focus Blast", "Fling", "Incinerate", "WillOWisp", "Shadow Claw", "Swords Dance", "Rock Slide", "Poison Jab", "Swagger", "Sleep Talk", "Substitute", "Rock Smash", "PowerUp", "Confide"};
