public class Donphan extends Pokemon{
{
		...
		type1 = "Ground";
		type2 = "";
		abilities = new String[]{"Sturdy", "Frisk", "Sand Veil", "Run Up", "Force"};
		...
		TMs = new String[]{"Roar", "Toxic", "Hidden Power", "Sunny Day", "Hyper Beam", "Protect", "Frustration", "Earthquake", "Return", "Double Team", "Sandstorm", "Rock Tomb", "Facade", "Rest", "Attract", "Round", "Echoed Voice", "Giga Impact", "Rock Polish", "Stone Edge", "Gyro Ball", "Bulldoze", "Rock Slide", "Poison Jab", "Swagger", "Sleep Talk", "Substitute", "Rock Smash"};
