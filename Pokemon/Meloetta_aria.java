public class Meloetta_aria extends Pokemon{
	{
		name = "Meloetta_aria";
		bHP = 10;
		bAtk = 8;
		...
		power = 3;
		underdog = false;
		other = new String[]{"Forme Change","Forme Change"};
		athl = 4;
		acro = 4;
		combat = 4;
		stealth = 2;
