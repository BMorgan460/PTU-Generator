public class Pumpkaboo extends Pokemon{
{
		...
		TMs = new String[]{"Toxic", "Hidden Power", "Sunny Day", "Light Screen", "Protect", "Safeguard", "Frustration", "Solar Beam", "Return", "Psychic", "Shadow Ball", "Double Team", "Flamethrower", "Sludge Bomb", "Fire Blast", "Facade", "Flame Charge", "Rest", "Attract", "Thief", "Round", "Energy Ball", "Charge Beam", "Incinerate", "WillOWisp", "Explosion", "Flash", "Gyro Ball", "Rock Slide", "Dream Eater", "Grass Knot", "Swagger", "Sleep Talk", "Substitute", "Trick Room", "Rock Smash", "Nature Power", "Dark Pulse", "Confide"};
