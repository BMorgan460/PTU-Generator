public class Pupitar extends Pokemon{
{
		...
		TMs = new String[]{"Toxic", "Hidden Power", "Sunny Day", "Taunt", "Hyper Beam", "Protect", "Rain Dance", "Frustration", "Smack Down", "Earthquake", "Return", "Dig", "Brick Break", "Double Team", "Sandstorm", "Sandstorm", "Rock Tomb", "Torment", "Facade", "Rest", "Attract", "Round", "Payback", "Retaliate", "Rock Polish", "Stone Edge", "Bulldoze", "Rock Slide", "Swagger", "Sleep Talk", "Substitute", "Rock Smash", "Snarl", "Dark Pulse", "PowerUp", "Confide"};
		tutorMoves = new String[]{"Ancient Power", "Body Slam", "Slam", "Dark Pulse", "Earth Power", "Iron Defense", "Iron Head", "Iron Tail", "Outrage", "Sleep Talk", "Snore", "Spite", "Stealth Rock", "Superpower", "Uproar"};
