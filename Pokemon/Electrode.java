public class Electrode extends Pokemon{
	{
		...
		TMs = new String[]{"Toxic", "Hidden Power", "Taunt", "Hyper Beam", "Light Screen", "Protect", "Rain Dance", "Frustration", "Thunderbolt", "Thunder", "Return", "Double Team", "Torment", "Facade", "Rest", "Thief", "Round", "Charge", "Charge Beam", "Explosion", "Giga Impact", "Flash", "Volt Switch", "Thunder", "Thunder Wave", "Gyro Ball", "Swagger", "Sleep Talk", "Substitute", "Wild Charge"};
		tutorMoves = new String[]{"Foul Play", "Magic Coat", "Magnet Rise", "Magnetic Flux", "Role Play", "Rollout", "Shock Wave", "Signal Beam", "Sleep Talk", "Snore", "Sucker Punch", "Swift"};
