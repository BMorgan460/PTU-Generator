public class Unfezant extends Pokemon{
	{
		...
		type1 = "Normal";
		type2 = "Flying";
		abilities = new String[]{"Big Pecks", "Super Luck", "Rivalry", "Klutz", "HIGH"};
		...
		TMs = new String[]{"Work Up", "Toxic", "Hidden Power", "Sunny Day", "Taunt", "Hyper Beam", "Protect", "Rain Dance", "Roost", "Frustration", "Return", "Double Team", "Aerial Ace", "Facade", "Rest", "Attract", "Round", "Echoed Voice", "Steel Wing", "Giga Impact", "Fly", "Psych Up", "Swagger", "Sleep Talk", "Substitute", "Confide"};
