public class Oddish extends Pokemon{
	{
		...
		type1 = "Grass";
		type2 = "Poison";
		abilities = new String[]{"Photosynthesis", "Run Away", "Chlorophyll", "Oblivious", "Life Force"};
		...
		TMs = new String[]{"Cut", "Toxic", "Venoshock", "Hidden Power", "Sunny Day", "Protect", "Frustration", "Solar Beam", "Return", "Double Team", "Sludge", "Sludge Bomb", "Facade", "Rest", "Attract", "Round", "Energy Ball", "Flash", "Swords Dance", "Infestation", "Grass Knot", "Swagger", "Sleep Talk", "Substitute", "Nature Power", "Dazzling Gleam", "Confide"};
