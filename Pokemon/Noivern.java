public class Noivern extends Pokemon{
{
		...
		TMs = new String[]{"Hone Claws", "Dragon Claw", "Toxic", "Hidden Power", "Sunny Day", "Taunt", "Hyper Beam", "Protect", "Roost", "Frustration", "Solar Beam", "Return", "Psychic", "Shadow Ball", "Brick Break", "Double Team", "Flamethrower", "Aerial Ace", "Torment", "Facade", "Rest", "Attract", "Thief", "Round", "Echoed Voice", "Steel Wing", "Focus Blast", "Acrobatics", "Shadow Claw", "XScissor", "Dream Eater", "Swagger", "Sleep Talk", "UTurn", "Substitute", "Wild Charge", "Dark Pulse", "Confide"};
