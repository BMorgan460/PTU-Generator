public class Lillipup extends Pokemon{
{
		...
		TMs = new String[]{"Roar", "Toxic", "Hidden Power", "Sunny Day", "Protect", "Rain Dance", "Frustration", "Thunderbolt", "Return", "Dig", "Shadow Ball", "Double Team", "Rock Tomb", "Aerial Ace", "Facade", "Rest", "Attract", "Round", "Retaliate", "Giga Impact", "Thunder Wave", "Swagger", "Sleep Talk", "Substitute", "Wild Charge", "Rock Smash", "Snarl", "Confide"};
