public class Groudon extends Pokemon{
	{
		...
		type1 = "Ground";
		type2 = "";
		abilities = new String[]{"Drought", "Solar Power", "Sun Blanket", "Mold Breaker", "Sand Force"};
		...
		underdog = false;
		other = new String[]{"Firestarter","Glow","Groundshaper","Materializer","Mountable 1","Tremorsense"};
		athl = 5;
		acro = 3;
		combat = 5;
		stealth = 2;
