public class Bayleef extends Pokemon{
	{
		...
		percepBonus = 0;
		focusBonus = 0;
		movesLevels = new int[]{3, 6, 9, 12, 18, 22, 26, 32, 36, 40, 46, 50, 54};
		...
		tutorMoves = new String[]{"Ancient Power", "Bullet Seed", "Counter", "Fury Cutter", "Giga Drain", "Grass Pledge", "Iron Tail", "Laser Focus", "Magic Coat", "Role Play", "Secret Power", "Seed Bomb", "Snore", "Synthesis", "Worry Seed"};
