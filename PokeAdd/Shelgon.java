public class Shelgon extends Pokemon{
	{
		...
		percepBonus = 1;
		focusBonus = 3;
		movesLevels = new int[]{4, 7, 10, 13, 17, 21, 25, 29, 35, 42, 49, 56};
		...
		tutorMoves = new String[]{"Body Slam", "Slam", "Defense Curl", "Draco Meteor", "Dragon Pulse", "Fury Cutter", "Hyper Voice", "Iron Defense", "Outrage", "Rollout", "Snore", "Twister", "Zen Headbutt", "Headbutt"};
