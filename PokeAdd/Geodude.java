public class Geodude extends Pokemon{
	{
		...
		eggMoves = new String[]{"Autotomize", "Block", "Curse", "Endure", "Flail", "Focus Punch", "Hammer Arm", "Mega Punch", "Rock Climb", "Wide Guard"};
		tutorMoves = new String[]{"Ancient Power", "Block", "Body Slam", "Slam", "Counter", "Dynamic Punch", "Earth Power", "Fire Punch", "Focus Punch", "Iron Defense", "Metronome", "Rollout", "Seismic Toss", "Snore", "Stealth Rock", "Sucker Punch", "Superpower", "Thunder Punch"};
