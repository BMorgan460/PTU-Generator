public class Carbink extends Pokemon{
	{
		...
		tutorMoves = new String[]{"After You", "Ally Switch", "Ancient Power", "Covet", "Earth Power", "Gravity", "Iron Defense", "Magic Coat", "Magnet Rise", "Skill Swap", "Snore", "Stealth Rock", "Stomping Tantrum", "Telekinesis", "Wonder Room"};
